#ifndef CRPROPERTYMANAGER_HPP
#define CRPROPERTYMANAGER_HPP
        ...
        public:
            ...
            */
            ...
            TYPE get(const std::string propertyID)
            {
                ...
                {
                    if(_propertyList.at(propertyID)->get_type()->name() == typeid(TYPE).name())
                        return static_cast<TProperty<TYPE>*>(_propertyList[propertyID])->get_value();
                }
                else
                {
            ...
            */
            ...
            void set(const std::string propertyID, TYPE theValue)
            {
                ...
                {
                    if(_propertyList.at(propertyID)->get_type()->name() == typeid(TYPE).name())
                        static_cast<TProperty<TYPE>*>(_propertyList[propertyID])->set_value(theValue);
                }
                else
                {
            ...
            */
            ...
            void add(const std::string thePropertyID, TYPE theValue)
            {
                ...
                {
                    TProperty<TYPE> * aProperty = new(std::nothrow) TProperty<TYPE>(thePropertyID);
